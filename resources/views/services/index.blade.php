...
{{--        <h1 class="font-serif text-3xl font-bold underline decoration-gray-400"> Post Index</h1>--}}
        <div class="flex justify-end">
            <a href="{{ route('services.create') }}" class="px-4 py-2 rounded-md bg-sky-500 text-sky-100 hover:bg-sky-600 text-white">Create Post</a>
        </div>
    </div>
                    ...
                    <tbody class="bg-dark text-white">
                        @foreach($services as $service)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-900 text-white">
                                        {{ $service->title }}
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
