                        ...
                        <div class="w-full rounded bg-white px-8 py-8 shadow-md ring-1 ring-gray-900/10 m-5">
                            <form method="POST" action="{{ route('services.store') }}">
                                ...
                                <div>
                                    ...
                                    <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="title" placeholder="title">
                                </div>
                                <div>
...
{{--                                <div>--}}
{{--                                    <label class="block text-sm font-medium text-gray-700" for="create_at"> Create_at </label>--}}
{{--                                    <input class="block w-full mt-1 border-gray-300 rounded-md shadow-sm placeholder:text-gray-400 placeholder:text-right focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" type="text" name="create_at" placeholder="180">--}}
{{--                                </div>--}}
